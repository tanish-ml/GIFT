...
export class DigitalCredentialsProcessor {
    ...
    async setVirtualWalletBehavior(params) {
        ...
        if (action === "respond" /* DigitalCredentials.VirtualWalletAction.Respond */) {
        ...
        if (context === undefined) {
            if (action === "clear" /* DigitalCredentials.VirtualWalletAction.Clear */) {
    ...
    async #applyBehaviorToTarget(target) {
        ...
        if (behavior === null || behavior === undefined) {
            await this.#sendCdpCommand(target, {
                action: "clear" /* DigitalCredentials.VirtualWalletAction.Clear */,
            });
            return;
        }
...
//# sourceMappingURL=DigitalCredentialsProcessor.js.map
